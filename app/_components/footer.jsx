...
const columns = [
  ...
  },
  {
    heading: "Connect",
    links: [
      { label: "nexttab@gmail.com", href: "mailto:nexttab@gmail.com" },
      { label: "+254 112 922 255", href: "tel:+254112922255" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
            ...
            <p className="text-sm text-body leading-5 max-w-[200px]">
              Full-service software engineering for startups, SMEs, commerce, and enterprise — built in Nairobi, delivered worldwide.
            </p>
          </div>
        ...
        <div className="border-t border-hairline pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-mute">
            &copy; {new Date().getFullYear()} NextTab Solutions. All rights reserved.
          </p>
          <div className="flex gap-5">
            {[
              ...
              <Link
                ...
                href="#"
                aria-label={label}
                className="text-mute hover:text-body transition-colors duration-150"
              >
